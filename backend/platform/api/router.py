...
API_ROUTE_REGISTRY = APIRouteRegistry(
    (
        ...
        RouteSpec("POST", "/api/metric-dictionary/import", "metric_dictionary_import", "metrics", "Import new metrics from an Excel workbook without overwriting existing records."),

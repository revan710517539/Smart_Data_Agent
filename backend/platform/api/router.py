...
API_ROUTE_REGISTRY = APIRouteRegistry(
    (
        ...
        RouteSpec("GET", "/api/system-config", "system_config_get", "settings", "List model, speech-to-text and data integrations."),
        ...
        RouteSpec("POST", "/api/system-config/data-connection", "system_data_connection_upsert", "settings", "Create or update data connection."),
        RouteSpec("POST", "/api/system-config/data-connection/test", "system_data_connection_test", "settings", "Validate a data connection against the configured warehouse catalog."),
        RouteSpec("DELETE", "/api/system-config/data-connection", "system_data_connection_delete", "settings", "Delete data connection."),

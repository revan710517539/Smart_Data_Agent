...
require("/opt/smart-data-agent/src/app/data" in server_compose, "server_compose_host_data_contract")
...
require("network_mode: bridge" in server_compose, "server_compose_existing_bridge_network")
require('SMART_DATA_AGENT_EMBEDDED_WORKER: "${SMART_DATA_AGENT_EMBEDDED_WORKER:-true}"' in server_compose, "server_compose_worker")
require(
    'SMART_DATA_AGENT_DEVELOPMENT_LOGIN_PASSWORD: "${SMART_DATA_AGENT_DEVELOPMENT_LOGIN_PASSWORD:?' in server_compose,
    "server_compose_login_password_required",
)
...
require("check_server_deployment_contract.py" in ci, "ci_deployment_contract_gate")
...
for content, label in ((readme, "readme"), (deployment_doc, "deployment_doc")):
    ...
    require("/opt/smart-data-agent/src/app/data" in content, f"{label}_server_host_path")

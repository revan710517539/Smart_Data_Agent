...
assert.match(composerSource, /includeNewlyAssigned: pageCode === "weekly_report" \|\| pageCode === "institution_supervision" \|\| pageCode === "customer_segment_analysis"/, "单机构和分客群页面必须把新指定数据集追加到已保存布局之后");

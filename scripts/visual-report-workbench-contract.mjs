...
assert.match(builder, /openReport\(newVisualReport\(\), "browse"\)/, "新建报表必须先显示便签、编辑、留言板的标准初始化页头");
...
assert.ok(builder.indexOf("<StandardAnalysisPageHeader") < builder.indexOf('<DestinationButton label="存周报"'), "报表沉淀操作必须移出统一页头，避免打断便签、编辑、留言板顺序");
